...
struct NewsView: View {
    ...
    private func contentCard(
            ...
            HStack(spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 6) {
                    HStack(spacing: 6) {
                        ...
                        if featured {
                            badge("FEATURED", tint: DrakonBladePalette.gold)
                        }
                    }
        ...
        .clipShape(DrakonBladeShape(pointDepth: 30, slant: 14))
        .overlay(
            DrakonBladeShape(pointDepth: 30, slant: 14)
                .stroke(
                    featured
    ...
    private func badge(_ title: String, tint: Color) -> some View {
        Text(title)
            ...
            .foregroundStyle(tint == DrakonBladePalette.gold ? .black : .white)
