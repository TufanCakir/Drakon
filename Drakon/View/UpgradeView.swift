...
struct UpgradeView: View {
    ...
    @ObservedObject private var medalManager = DrakonMedalManager.shared
    ...
    private func upgradeCard(_ owned: OwnedCharacter) -> some View {
        ...
        let canUpgrade =
            ...
            && coinManager.coins >= (cost?.coins ?? 0)
            && !owned.isMaxStar
        ...
        return VStack(spacing: 10) {
            ...
            Button {
                ...
                Text(owned.isMaxStar ? "MAX" : "STAR UP")
                    ...
                    .foregroundStyle(
                        canUpgrade
                            ? DrakonBladePalette.black : .white.opacity(0.45)
                    )
    ...
    private func upgrade(
        ...
        if let coins = cost.coins, !coinManager.spend(coins) {
